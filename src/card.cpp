...
Card::Card(const Player &player, const Stats &stats, const Language &language, const CardEdition &cardEdition, const CardTemplate &cardType)
...
CardTemplate Card::getType() const { return type; }
Language Card::getLanguage() const { return language; }
CardDimentions Card::getDimentions() const { return dimentions; }

std::string Card::toString() const
{
  return "Card(Player: " + player.toString() + ", Stats: " + stats.toString() + ", Language: " + getLanguageCode(language) + ", Edition: " + getCardEditionName(edition) + ", Template: " + getCardName(type) + ")";
}